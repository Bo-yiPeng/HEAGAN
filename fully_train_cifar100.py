...
def parse_args():
    ...
    parser.add_argument('--data_path', type=str, default='data/datasets/cifar-100', help='dataset path')

    parser.add_argument('--exp_name', type=str, default='arch_train_cifar100', help='experiment name')
    parser.add_argument('--gpu_ids', type=str, default="0", help='visible GPU ids')
    parser.add_argument('--num_workers', type=int, default=8, help='number of cpu threads to use during batch generation')
    parser.add_argument('--checkpoint', type=str, help='checkpoint path')

    # train
    parser.add_argument('--arch', type=str, default='arch_cifar100', help='architecture name')
    ...
    parser.add_argument('--genotype_of_G', type=str, default='lambda_consistency=0.5-arch_searchG_cifar10_2025_07_27_14_54_24/Model/best_fid_gen.npy', help='ues genotypes of the experiment')
...
def main():
    ...
    if args.dataset.lower() == 'cifar10':
        ...
        fid_stat = './fid_stat/cifar100.train.npz'
    ...
    for epoch in tqdm(range(int(start_epoch), int(args.max_epoch_D)), desc='total progress'):
        ...
        if epoch == 605:
            break
        if (epoch % args.val_freq == 0 and epoch > 400) or epoch == 210 or 210<epoch<=400:
